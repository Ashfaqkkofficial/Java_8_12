package com.example.PrivateMethodsInInterfaces;
...
public class PrivateMethodsInInterfacesApplication {

	@Value("${rss.url.feed}")
	String rssFeedUrl;

	public static void main(String[] args) {
		SpringApplication.run(PrivateMethodsInInterfacesApplication.class, args);
	}
