package com.example.LocalVariableForInterface;
...
public class LocalVariableForInterfaceApplication {

	@Value("${rss.url.feed}")
	String rssFeedUrl;

	public static void main(String[] args) {
		SpringApplication.run(LocalVariableForInterfaceApplication.class, args);
	}
